...
yolact_plus_pascal_sbd_config = yolact_plus_base_config.copy({
    'name': 'yolact_plus_pascal_sbd',
    # Dataset stuff
    'dataset': pascal_sbd_dataset,
    'num_classes': len(pascal_sbd_dataset.class_names) + 1,
...
yolact_plus_resnet50_cig_butts_config = yolact_plus_resnet50_config.copy({
...
yolact_plus_huber_loss_cig_butts_config = yolact_plus_cig_butts_config.copy({
    'name': 'yolact_plus_huber_loss_cig_butts',
    'use_huber_loss': True,
})

yolact_plus_huber_loss_cig_butts_1_5_delta_config = yolact_plus_huber_loss_cig_butts_config.copy({
    'huber_loss_delta': 1.5,
})

yolact_plus_huber_loss_cig_butts_1_3_delta_config = yolact_plus_huber_loss_cig_butts_config.copy({
    'huber_loss_delta': 1.3,
})

yolact_plus_dice_loss_cig_butts_config = yolact_plus_cig_butts_config.copy({
    'name': 'yolact_plus_dice_loss_cig_butts',
    'use_dice_loss': True,
})

yolact_plus_log_cosh_bce_loss_cig_butts_config = yolact_plus_cig_butts_config.copy({
    'name': 'yolact_plus_log_cosh_bce_loss_cig_butts',
    'use_log_cosh_bce_loss': True,
})

yolact_plus_log_cosh_dice_loss_cig_butts_config = yolact_plus_cig_butts_config.copy({
    'name': 'yolact_plus_log_cosh_dice_loss_cig_butts',
    'use_log_cosh_dice_loss': True,
})

yolact_plus_mse_loss_cig_butts_config = yolact_plus_cig_butts_config.copy({
    'name': 'yolact_plus_mse_loss_cig_butts',
    'use_MSE_loss': True,
})

yolact_plus_huber_bce_loss_cig_butts_config = yolact_plus_cig_butts_config.copy({
    'name': 'yolact_plus_huber_bce_loss_cig_butts',
    'double_loss_type': 'huber_loss',
    'mask_proto_double_loss': True,
    'mask_proto_double_loss_alpha': 1,
})

yolact_plus_mse_huber_loss_cig_butts_config = yolact_plus_huber_loss_cig_butts_config.copy({
    'name': 'yolact_plus_mse_huber_loss_cig_butts',
    'double_loss_type': 'mse_loss',
    'mask_proto_double_loss': True,
    'mask_proto_double_loss_alpha': 1,
})

yolact_plus_mse_bce_loss_cig_butts_config = yolact_plus_cig_butts_config.copy({
    'name': 'yolact_plus_mse_bce_loss_cig_butts',
    'double_loss_type': 'mse_loss',
    'mask_proto_double_loss': True,
    'mask_proto_double_loss_alpha': 1,
})

yolact_plus_huber_loss_coco_config = yolact_plus_huber_loss_cig_butts_config.copy({
    'name': 'yolact_plus_huber_loss_coco',
    # Dataset stuff
    'dataset': coco2017_dataset,
    'num_classes': len(coco2017_dataset.class_names) + 1,
    # Image Size
...
yolact_plus_mse_bce_loss_coco_config = yolact_plus_mse_bce_loss_cig_butts_config.copy({
    'name': 'yolact_plus_mse_bce_loss_coco',
    # Dataset stuff
    'dataset': coco2017_dataset,
    'num_classes': len(coco2017_dataset.class_names) + 1,
    # Image Size
